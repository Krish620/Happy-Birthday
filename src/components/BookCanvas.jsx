import kaliPhoto from "../assets/kali.jpeg";
                ...
                <div className="card1">
                    <div className="cover-text-wrapper">
                        <h4 className="username">
                            Dear Kali<span className="underline"></span>
                        </h4>
                    ...
                    {/* Decorative cake emoji in place of a photo */}
                    <div className="userImg">
                        <img src={kaliPhoto} alt="Kali" />
                        </div>
                ...
                <div className="card2">
                    <div className="card2-content">
                        ...
                        <div className="card2-message-text italic">
                            <article style={{ marginBottom: '8px' }}>Happy Birthday, Kali 🎂</article>
                            <article style={{ marginBottom: '10px' }}>Another year of you being you — chaotic, brilliant, and impossible to replace. Growing up with you has meant a lifetime of inside jokes, arguments over nothing, and always having someone in my corner.</article>
                            <article style={{ marginBottom: '10px' }}>I hope this year brings you everything you're chasing, and a few things you didn't even know you wanted. Whatever happens, I've got your back — always.</article>
                            <article style={{ marginBottom: '10px' }}>You're not just another year older today...<br />
                                you're one more year of being an awesome sister. Happy Birthday!</article>
                        </div>
